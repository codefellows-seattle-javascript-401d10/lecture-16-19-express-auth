...
exports.uploadMock = {
  ...
  Location: 'https://bookstagram-assets.s3.amazonaws.com/cd52be0bc15dd9500e87d9afcf35c19e.png',
...
AWSMock.mock('S3', 'upload', function(params, callback){
  ...
  if(params.Bucket !== 'bookstagram-assets')
    return callback(new Error('Bucket must be bookstagram-assets'));
  if(!params.Key)
